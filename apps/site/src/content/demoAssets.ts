...
export const demoAssets = {
  vitakiosk: {
    ...
    get ipad() {
      return {
        screenshots: this.ipadScreenshots,
        videos: this.videos,
      };
    },
    get largeKiosk() {
      return {
        screenshots: this.largeKioskScreenshots,
        videos: this.videos,
      };
    },
  },
...
export const showcaseTabs = [
  { label: "VitaKiosk iPad", assets: demoAssets.vitakiosk.ipadScreenshots },
  { label: "VitaKiosk Kiosk", assets: demoAssets.vitakiosk.largeKioskScreenshots },
  { label: "VitaFlow ERP", assets: demoAssets.vitaflow.screenshots },
  { label: "Clinic Partner Flow", assets: demoAssets.showcasePosters },
];

export function hasProtectedErpReleasePath(value: string): boolean {
  return /C:\\Users\\Admin\\Documents\\Playground\\release/i.test(value);
}

export const demoAssetsLegacy = {
  ...demoAssets,
  vitakiosk: {
    ...demoAssets.vitakiosk,
    ipad: {
      screenshots: demoAssets.vitakiosk.ipadScreenshots,
      videos: demoAssets.vitakiosk.videos,
    },
    largeKiosk: {
      screenshots: demoAssets.vitakiosk.largeKioskScreenshots,
      videos: demoAssets.vitakiosk.videos,
    },
  },
  vitaflow: {
    ...demoAssets.vitaflow,
    state: demoAssets.vitaflow.screenshots[0]?.kind,
    sourceLabel: demoAssets.vitaflow.screenshots[0]?.label,
  },
};

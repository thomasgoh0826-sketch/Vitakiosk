...
| Backend tests | `python -m pytest backend/tests -v` | 59 passed | Pass |
...
| Frontend tests | `npm.cmd run test:run --prefix frontend` | 14 files, 75 tests passed | Pass |
...
| Frontend build | `npm.cmd run build --prefix frontend` | TypeScript and Vite production build completed; default bundle 345.13kB JS before gzip, optional lazy ThreeAvatarRenderer chunk 80.26kB, VrmAvatarRenderer chunk 194.03kB, AvatarModel chunk 862.26kB, CSS bundle 62.19kB, local VRM asset 15,369.46kB, and alternate local VRM asset 16,532.72kB | Pass |
